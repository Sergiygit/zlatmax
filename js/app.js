(() => {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".swiper")) new core(".swiper", {
                ...
                on: {
                    init: function(swiper) {
                        ...
                        const allSlidesItems = document.querySelectorAll(".swiper-slide-main-block:not(.swiper-slide-duplicate)");
            ...
            if (document.querySelector(".products")) new core(".products", {
                ...
                pagination: {
                    el: ".controll-products-slider__dotts",
                    clickable: true,
                    dynamicBullets: true
                },
                navigation: {
            ...
            if (document.querySelector(".newproducts")) new core(".newproducts", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".light")) new core(".light", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
            ...
            if (document.querySelector(".card")) new core(".card", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
